...
goal(deliver_box(box1,area26)).
goal(deliver_box(box2,area35)).
goal(deliver_box(box3,area14)).
goal(deliver_box(box4,area10)).
goal(deliver_box(box5,area25)).
goal(deliver_box(box6,area16)).
goal(deliver_box(box7,area41)).
goal(deliver_box(box8,area31)).
goal(deliver_box(box9,area21)).
goal(deliver_sample(cdm2,area28)).
goal(deliver_sample(cdm1,area50)).
goal(deliver_sample(cdm3,area24)).
goal(deliver_sample(cdm3,area2)).
goal(deliver_sample(cdm4,area32)).
goal(deliver_sample(cdm5,area1)).
goal(deliver_sample(cdm5,area10)).
goal(deliver_sample(cdm1,area13)).
goal(deliver_sample(cdm5,area27)).
...
+!replan(Goal,Role) : count(C) & replan(R) & C + R == 29 & round(Round) & time(Start)
<-
	-count(C);
	+count(0);
	if (R == 0) {
...
+!count : count(C) & C == 29 & time(Start) & replan(0) & round(Round)
<-
	jia.time(Start,Final);
	+time_ind_plan((Final-Start)/1000000000.0);
	.print("Elapsed time individual planning round ",Round,": ",(Final-Start)/1000000000.0);
	...
	.stopMAS;
	.
+!count : count(C) & replan(R) & C + R == 29  & round(Round) & time(Start)
<-
	-count(C);
	+count(0);
	if (R == 0) {
