...
goal(get_picture(disaster8)).
goal(get_picture(disaster9)).
goal(get_picture(disaster10)).
goal(get_picture(disaster11)).
goal(get_picture(disaster12)).
goal(get_picture(disaster13)).
goal(get_picture(disaster14)).
goal(get_picture(disaster15)).
goal(get_picture(disaster16)).
goal(deliver_box(box1,area29)).
goal(deliver_box(box2,area33)).
goal(deliver_box(box3,area39)).
goal(deliver_box(box4,area54)).
goal(deliver_box(box5,area6)).
goal(deliver_box(box6,area31)).
goal(deliver_box(box7,area7)).
goal(deliver_box(box8,area21)).
goal(deliver_box(box9,area15)).
goal(deliver_box(box10,area18)).
goal(deliver_sample(cdm2,area35)).
goal(deliver_sample(cdm1,area40)).
goal(deliver_sample(cdm3,area2)).
goal(deliver_sample(cdm3,area17)).
goal(deliver_sample(cdm4,area8)).
goal(deliver_sample(cdm5,area28)).
goal(deliver_sample(cdm6,area4)).
goal(deliver_sample(cdm6,area56)).
goal(deliver_sample(cdm5,area33)).
goal(deliver_sample(cdm1,area37)).
...
+!replan(Goal,Role) : count(C) & replan(R) & C + R == 35 & round(Round) & time(Start)
<-
	-count(C);
	+count(0);
	if (R == 0) {
...
+!count : count(C) & C == 35 & time(Start) & replan(0) & round(Round)
<-
	jia.time(Start,Final);
	+time_ind_plan((Final-Start)/1000000000.0);
	.print("Elapsed time individual planning round ",Round,": ",(Final-Start)/1000000000.0);
	...
	.stopMAS;
	.
+!count : count(C) & replan(R) & C + R == 35  & round(Round) & time(Start)
<-
	-count(C);
	+count(0);
	if (R == 0) {
