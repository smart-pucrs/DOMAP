...
goal(deliver_box(box1,area41)).
goal(deliver_box(box2,area44)).
goal(deliver_box(box3,area48)).
goal(deliver_box(box4,area3)).
goal(deliver_box(box5,area50)).
goal(deliver_box(box6,area33)).
goal(deliver_box(box7,area8)).
goal(deliver_box(box8,area51)).
goal(deliver_box(box9,area13)).
goal(deliver_box(box10,area55)).
goal(deliver_sample(cdm2,area36)).
goal(deliver_sample(cdm1,area30)).
goal(deliver_sample(cdm3,area12)).
goal(deliver_sample(cdm3,area50)).
goal(deliver_sample(cdm4,area19)).
goal(deliver_sample(cdm5,area28)).
goal(deliver_sample(cdm6,area38)).
goal(deliver_sample(cdm6,area54)).
goal(deliver_sample(cdm5,area1)).
goal(deliver_sample(cdm1,area48)).
...
+!replan(Goal,Role) : count(C) & replan(R) & C + R == 32 & round(Round) & time(Start)
<-
	-count(C);
	+count(0);
	if (R == 0) {
...
+!count : count(C) & C == 32 & time(Start) & replan(0) & round(Round)
<-
	jia.time(Start,Final);
	+time_ind_plan((Final-Start)/1000000000.0);
	.print("Elapsed time individual planning round ",Round,": ",(Final-Start)/1000000000.0);
	...
	.stopMAS;
	.
+!count : count(C) & replan(R) & C + R == 32  & round(Round) & time(Start)
<-
	-count(C);
	+count(0);
	if (R == 0) {
